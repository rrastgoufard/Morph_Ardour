ardour {
  ["type"]    = "session",
  name        = "Morph Parameter Printer",
  license     = "MIT",
  author      = "RR",
  description = [[In newer Ardour releases (likely 7.3 and beyond), this will be unnecessary.  This finds all unique plugins in the Session and prints out their parameter lists.  Morph Controller (ver2) and Morph Locator (ver2) are DSP plugins that take care of themselves.]]
} 
